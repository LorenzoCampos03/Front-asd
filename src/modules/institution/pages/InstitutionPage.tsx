      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex gap-2">
            <button
              className={`px-4 py-2 text-sm font-medium rounded-lg transition duration-200 ${filter === 'activos'
            ...
            <button
              className={`px-4 py-2 text-sm font-medium rounded-lg transition duration-200 ${filter === 'inactivos'
            ...
            <button
              className={`px-4 py-2 text-sm font-medium rounded-lg transition duration-200 ${filter === 'todos'
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`px-3 py-1 text-xs font-semibold rounded-full ${institution.status === 'ACTIVE'
                      ? 'bg-green-100 text-green-800'
                      : 'bg-red-100 text-red-800'
                      }`}>
